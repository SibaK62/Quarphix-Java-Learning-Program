...
public class Student
{
    ...
    public Student(String name , double average)
    {
        ...
        //keep intance variable average's default value (0.0)
        if (average >0.0)
           if (average <= 100.0)
              this .average = average; // assign ton instance varable
    ...
    public void setyAverag( double studentAverage)
    {
        //validate that average is >0.0 and <= 100.0; otherwise,
        // keep instance varaible average's current value
        if (average >0.0)
           if (average <= 100.0)
             this.average = average ; // assign to instance variable
    }

    //retrieves this Stusent's average 
